...
export const OCCASIONS = [
  ...
  { id: "formal", name: "Formal", icon: "ribbon-outline" },
  { id: "party", name: "Party", icon: "beer-outline" },
  { id: "sport", name: "Sport", icon: "fitness-outline" },
  { id: "beach", name: "Beach", icon: "umbrella-outline" },
  { id: "travel", name: "Travel", icon: "airplane-outline" },
  { id: "date", name: "Date", icon: "heart-outline" },
  { id: "wedding", name: "Wedding", icon: "sparkles-outline" },
];